...
urlpatterns = [
    ...
    path('add-restaurant/', views.add_restaurant_flutter, name='add_restaurant_flutter'),
    path('edit/<uuid:restaurant_id>/', views.edit_restaurant, name='edit_restaurant'),
    path('delete/<uuid:restaurant_id>/', views.delete_restaurant_flutter, name='delete_restaurant_flutter'),
